...
You'll analyze four critical risk categories: prompt injection, lateral movement, data exfiltration, and excessive agency.

You will also examine how these threats can compound when agents exchange data and call real-world tools.
